...
function Order() {
  ...
  return (
    <Layout>
      {loading && <Loader />}
      {(order.length > 0 && order.some(obj => obj.userid === userid)) ?
        (<>
        ...
        :
        (
          <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 mt-24 mb-20">
            <h2 className='text-center text-2xl text-black' style={{ color: mode === 'dark' ? 'white' : '' }}>No Orders</h2>
          </div>
